Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    resources :organization, :division, :service, :control_point, :manufacturer, :measurement_group, :device_reg_group,
  ...
  resources :organization, :division, :service, :control_point, :device_model, :measurement_class,
