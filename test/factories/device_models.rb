FactoryBot.define do
  factory :device_model do
    name
    measurement_group { association :measurement_group, id: 1, name: 'mg-test' }
    measurement_class { association :measurement_class, name: 'mc-test', measurement_group: MeasurementGroup.find_by_id(1) }
